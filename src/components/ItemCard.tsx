  ...
  return (
    <ContextMenu entries={itemMenuEntries(item)} disabled={overlay}>
      <div
        ...
        className={cn(
          'group/card relative cursor-pointer select-none rounded-lg border border-line bg-elevated p-2.5 shadow-sm transition-[box-shadow,background,transform] duration-150 hover:bg-subtle',
      ...
      >
        <div
          className="absolute right-1.5 top-1.5 opacity-0 transition-opacity group-hover/card:opacity-100 has-[[data-state=open]]:opacity-100"
